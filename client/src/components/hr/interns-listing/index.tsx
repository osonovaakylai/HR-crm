...
@observer
export default class InternsListingView extends React.Component<Props, {}> {
  ...
  componentWillMount() {
    document.title = 'Interns listing'
    ...
    return (
      <div id="base-view">
        <section className="listing-title">
          <p className="size36 semibold">Interns </p>
          <p className="size36 semibold mob">Interns</p>
        </section>
        ...
        <section className="listing-content ga">
          ...
          :
          <p className='no-data'>There is no interns yet.</p>
        }
      </div>
    )
  }
