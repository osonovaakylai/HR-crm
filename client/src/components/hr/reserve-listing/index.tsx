...
@observer
export default class ReserveListingView extends React.Component<Props, {}> {
    ...
    return (
      <div id="base-view">
        <section className="listing-title">
          <p className="size36 semibold">Reserve</p>
          <p className="size36 semibold mob">Reserve</p>
        </section>
        ...
        <section className="listing-content ga">
          ...
          :
          <p className='no-data'>There is no reserve candidates yet.</p>
        }
      </div>
    )
  }
